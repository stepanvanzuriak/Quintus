...
const quintusSprites = function (Quintus) {
  /**
  ...
  */
    ...
    */
      init(name, asset, options) {
        ...
        this.frames =
          this.cols * Math.floor(this.h / (this.tileH + this.spacingY));
      },
    ...
    */
      fy(frame) {
        return Math.floor(
          Math.floor(frame / this.cols) * (this.tileH + this.spacingY) +
            this.sy,
        );
      },
