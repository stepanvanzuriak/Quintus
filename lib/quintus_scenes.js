...
const quintusScenes = function (Quintus) {
  ...
  */
    Q.collision = (function () {
      ...
      function satCollision(o1, o2) {
        let result1; let result2; let result;
  ...
  */
    ...
    */
      detect (func) {
        for (let i = this.items.length - 1; i >= 0; i--) {
          if (
            func.call(this.items[i], arguments[1], arguments[2], arguments[3])
          ) {
            return this.items[i];
          }
        }
    ...
    */
      search (obj, collisionMask) {
        ...
        collisionMask = Q._isUndefined(collisionMask)
          ? obj.p && obj.p.collisionMask
          : collisionMask;
    ...
    */
      collide (obj, options) {
        let col; let col2; let collisionMask; let maxCol; let curCol; let skipEvents;
   ...
   */
    Q.stageScene = function (scene, num, options) {
      ...
      if (Q._isObject(num)) {
        options = num;
        num =
          Q._popProperty(options, "stage") || (scene && scene.opts.stage) || 0;
      }
      ...
      // the default stage
      const StageClass =
        Q._popProperty(options, "stageClass") ||
        (scene && scene.opts.stageClass) ||
        Q.Stage;
