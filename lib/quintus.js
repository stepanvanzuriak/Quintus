...
const QuintusNew = () => {
  class QuintusKlass {
    constructor(selector, scope, options) {

    }
  }

  return new QuintusKlass();
}

const Quintus = function (opts) {
  /**
  ...
  */
  Q.setup = function (id, options) {
    ...
    if (options.scaleToFit) {
      ...
      const scaleRatio =
        gameRatio < winRatio ? winH / Q.el.height : winW / Q.el.width;
  ...
  */
  ...
  Q._audioAssetExtension = function () {
    ...
    return (Q._audioAssetPreferredExtension = Q._detect(
      ...
      (extension) =>
        snd.canPlayType(Q.audioMimeTypes[extension]) ? extension : null,
    ));
  };
  ...
  */
  ...
  Q.matrix2d = function () {
    return Q.matrices2d.length > 0
      ? Q.matrices2d.pop().identity()
      : new Q.Matrix2D();
  };
